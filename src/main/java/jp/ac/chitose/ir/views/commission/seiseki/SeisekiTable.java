...
public class SeisekiTable {
    ...
    public Grid<CommissionGpa2> getTableYearFirstAll(){
        ...
        grid.addColumn(CommissionGpa2::mid).setHeader("中央値");
    ...
    public Grid<CommissionGpa2First> getTableFirst(){
        ...
        grid.addColumn(CommissionGpa2First::mid).setHeader("中央値");
    ...
    public Grid<CommissionGpa2Second> getTableSecond(){
        ...
        grid.addColumn(CommissionGpa2Second::mid).setHeader("中央値");
    ...
    public Grid<CommissionGpa2Third> getTableThird(){
        ...
        grid.addColumn(CommissionGpa2Third::mid).setHeader("中央値");
    ...
    public Grid<CommissionGpa2Fourth> getTableFourth(){
        ...
        grid.addColumn(CommissionGpa2Fourth::mid).setHeader("中央値");
    ...
    public Grid<GetTableData> getTableSubjectFirst(){
        ...
        grid.addColumn(GetTableData::subject).setHeader("学年");
        grid.addColumn(GetTableData::human).setHeader("人数");
        grid.addColumn(GetTableData::average).setHeader("平均値");
        grid.addColumn(GetTableData::mid).setHeader("中央値");
        grid.addColumn(GetTableData::min).setHeader("最小値");
        grid.addColumn(GetTableData::max).setHeader("最大値");
        grid.addColumn(GetTableData::std).setHeader("標準偏差");
